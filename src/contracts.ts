...
export const operations:Record<string,z.ZodType>={
 ...
 message:z.object({...room,body:str(4000),reply_to:seq.optional(),causation:seq.optional(),recipients:z.array(uuid).max(8).default([]),relay:z.enum(['true','false']).optional()}),
 ...
 'delivery.prepare':z.object({...room,through:seq,payload:z.string().max(4000)}),
